...
<head>
    ...
    <title>SAPA SEHAT - RS Awal Bros</title>

    <link href="https://fonts.googleapis.com" rel="preconnect">
    <link href="https://fonts.gstatic.com" rel="preconnect" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;300;400;500;700;900&family=Montserrat:wght@100;300;400;500;600;700;800;900&display=swap"
        rel="stylesheet">
            ...
            <div class="container d-flex justify-content-center justify-content-md-between">
                <div class="contact-info d-flex align-items-center">
                    <i class="bi bi-envelope d-flex align-items-center"><a
                            href="mailto:info@rsawalbros.com">info@rsawalbros.com</a></i>
        ...
        <div class="branding d-flex align-items-center">
            <div class="container position-relative d-flex align-items-center justify-content-between">
                <a href="/" class="logo d-flex align-items-center">
                    <h1 class="sitename text-primary">SAPA SEHAT AWALBROS</h1>
                </a>
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <li><a href="{{ route('events.index') }}"
                                class="{{ request()->is('kegiatan*') ? 'active' : '' }}">Jadwal & Promo</a></li>
                        <li><a href="{{ route('contact') }}"
                                class="{{ request()->is('kontak') ? 'active' : '' }}">Kontak & Lokasi</a></li>
                        <li><a href="/admin" class="btn btn-primary text-white px-4 ms-3"
                                style="border-radius: 50px;">Login Admin</a></li>
                    </ul>
                    ...
                    <div class="col-lg-4 mb-4 mb-lg-0">
                        <div class="brand-section">
                            <a href="/" class="logo d-flex align-items-center mb-3 text-decoration-none">
                                <img src="{{ asset('assets/img/logo-awalbros.png') }}" alt="Logo Awal Bross"
                                    style="max-height: 50px; width: auto;">
                            </a>
                            <p class="brand-description text-muted small pe-lg-4">
                                Melayani dengan Cinta dan Kasih Sayang. Dapatkan layanan kesehatan terbaik dengan
                                fasilitas modern dan tenaga medis profesional.
                            </p>

                            <div class="contact-info mt-4">
                                <div class="contact-item d-flex align-items-start mb-3">
                                    <i class="bi bi-geo-alt fs-5 text-primary me-3 mt-1"></i>
                                    <span class="text-muted small">Jl. HR. Soebrantas No. 88, Panam<br>Kota Pekanbaru,
                                        Riau 28299</span>
                                </div>
                            ...
                            <div class="social-links d-flex mt-4">
                                <a href="#" class="text-secondary me-3 fs-5 hover-primary"><i
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3 mb-4">
                                    <div class="nav-column">
                                        ...
                                        <nav class="footer-nav d-flex flex-column gap-2 small">
                                            ...
                                            <a href="#" class="text-muted text-decoration-none">Kamar
                                                Operasi</a>
                                ...
                                <div class="col-6 col-md-3 mb-4">
                                    <div class="nav-column">
                                        ...
                                        <nav class="footer-nav d-flex flex-column gap-2 small">
                                            <a href="#" class="text-muted text-decoration-none">Klinik
                                                Memori</a>
                                            <a href="#" class="text-muted text-decoration-none">Trauma
                                                Center</a>
                                            <a href="#" class="text-muted text-decoration-none">Stroke
                                                Center</a>
                                            <a href="#" class="text-muted text-decoration-none">Pain
                                                Intervention</a>
                                ...
                                <div class="col-6 col-md-3 mb-4">
                                    <div class="nav-column">
                                        ...
                                        <nav class="footer-nav d-flex flex-column gap-2 small">
                                            ...
                                            <a href="#" class="text-muted text-decoration-none">Janji Temu &
                                                Akses</a>
                                            <a href="#" class="text-muted text-decoration-none">Medical Check
                                                Up</a>
                                        </nav>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-md-3 mb-4">
                                    <div class="nav-column">
                                        ...
                                        <nav class="footer-nav d-flex flex-column gap-2 small">
                                            <a href="#" class="text-muted text-decoration-none">Aplikasi
                                                StarDok</a>
                                            <a href="#" class="text-muted text-decoration-none">Halo Awal
                                                Bros</a>
                                            <a href="/admin"
                                                class="text-primary text-decoration-none mt-2 fw-bold"><i
                                                    class="bi bi-box-arrow-in-right"></i> Login Staf (Admin)</a>
                                        </nav>
                                    </div>
                                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 text-center text-lg-start mb-3 mb-lg-0">
                            <div class="copyright text-muted small">
                                <p class="mb-0">© <span class="sitename fw-bold text-dark">RS Awal Bros</span>
